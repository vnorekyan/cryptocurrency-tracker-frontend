...
@Component({
  selector: 'app-portfolio-dash',
  templateUrl: './portfolio-dash.component.html',
  styleUrls: ['./portfolio-dash.component.css']
})
export class PortfolioDashComponent implements OnInit {
  value = 0;
  percentage = 40;
  portfolios: any;
